...
public class Modificar extends javax.swing.JFrame {
     ...
     */
    public Modificar(int id_car) {
        control = new Controladora();
        initComponents();
        RegistrarDatos(id_car);
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
       ...
       //control.guardar(modelo, motor, cantPuertas, marca, color, placa);
       control.modificarAuto(auto, anio, cantPuertas, motor, marca, color, placa);
       
        mostrarMensaje("Edicion realizada correctamente", "Info", "Edicion Correcta");
        pantalla = new VerCatalogo();
    ...
    private void RegistrarDatos(int id_car) {
        this.auto = control.traerAuto(id_car);
        
        Object anio = auto.getAnio();
        cmbModelo.setSelectedItem(anio);
        
        Object motor = auto.getMotor();
        cmbMotor.setSelectedItem(motor);
        
        Object cantPuertas =auto.getCantPuertas();
        cmbCantPuertas.setSelectedItem(cantPuertas);
